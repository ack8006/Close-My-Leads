...
def close(self, lead_guid):
    opener = urllib2.build_opener(urllib2.HTTPHandler)
    request = urllib2.Request('https://hubapi.com/leads/v1/lead/' + lead_guid + '?hapikey=' + self.request.cookies['auth'], '{"closedAt":%s}' % self.request.get(date))
